...
def create_sell(request):
    if request.method == 'POST':
        ...
        try:
            sel = sell.objects.create(creater=request.user, Title=Title, picture=picture,price=price,category=category,description=description,
...
#         pro.date_created=request.POST['date_created']
